...
import com.ail.payment.PaymentAuthorisedService;

/**
 * Implementation of the payment approved service for PayPal. In the case
...
public class PayPalPaymentAuthorisedService extends Service<PaymentAuthorisedService.PaymentAuthorisedArgument> {
    @Override
    public void invoke() {
    }
}
