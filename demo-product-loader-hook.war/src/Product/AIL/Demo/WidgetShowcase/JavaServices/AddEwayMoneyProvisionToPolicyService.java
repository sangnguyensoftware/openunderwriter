...
/**
 * The BuyWithEwayButton requires that the policy contains a Eway based
 * MoneyProvision at status NEW. This method creates such a MoneyProvision.
 */
public class AddEwayMoneyProvisionToPolicyService {
    public static void invoke(ExecutePageActionArgument args) {
        ...
        if (policy.getPaymentDetails() == null) {
            ...
            String description = I18N.i18n("i18n_buy_with_eway_payment_description");
            PaymentMethod pm = new Eway();
