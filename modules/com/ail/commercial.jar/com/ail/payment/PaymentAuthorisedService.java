 ...
 */
@ServiceInterface
public class PaymentAuthorisedService {
    
    @ServiceArgument
    public interface PaymentAuthorisedArgument extends Argument {
    ...
    public interface PaymentAuthorisedCommand extends PaymentAuthorisedArgument, Command {
    }
}
