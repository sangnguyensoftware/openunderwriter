...
@ProductServiceCommand(serviceName = "AcceptQuotationActionService", commandName = "AcceptQuotationAction")
public class AcceptQuotationActionService {
    public static void invoke(ExecutePageActionArgument args) {
        ...
        try {
            ...
            AcceptQuotationCommand command = (AcceptQuotationCommand) core.newCommand(AcceptQuotationCommand.class);
