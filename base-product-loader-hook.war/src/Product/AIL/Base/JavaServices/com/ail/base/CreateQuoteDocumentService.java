 ...
 */
@ProductServiceCommand(serviceName = "CreateQuoteDocumentService", commandName = "CreateQuoteDocumentAction")
public class CreateQuoteDocumentService {
    public static void invoke(ExecutePageActionArgument args) throws Exception {
        ...
        FetchDocumentCommand command = (FetchDocumentCommand) core.newCommand("FetchQuotationDocument", FetchDocumentCommand.class);
