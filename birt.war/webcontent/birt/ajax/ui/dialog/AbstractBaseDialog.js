	...
	*/
	...
	__l_show : function( )
	{
		...
		if(!this.visible)
		{
			...
			// OpenUnderwriter fix to resize popup so it will work in the context of a widget
			$("exceptionDialog").style.width="80%";
			$("exceptionDialog").style.margin="10%";
			$("exceptionDialog").style.left="0";
			$("exceptionDialog").style.top="0";
			$("exceptionDialogdialogContentContainer").style.width="100%";
			$("faultStringContainer").style.width="100%";
			// End of OpenUnderwriter fix
