...
import com.ail.insurance.onrisk.GeneratePolicyDocumentService.GeneratePolicyDocumentCommand;
import com.ail.insurance.policy.Policy;

@ServiceImplementation
public class FetchPolicyDocumentService extends Service<FetchDocumentArgument> {
   ...
   /**
    ...
    public void invoke() throws BaseException {
        ...
        // generate it.
        if (policy.retrievePolicyDocument() == null) {
            GeneratePolicyDocumentCommand cmd = getCore().newCommand(GeneratePolicyDocumentCommand.class);
            cmd.setPolicyArg(policy);
            cmd.invoke();
            policy.attachPolicyDocument(cmd.getDocumentRet());
            policy = getCore().update(policy);
            args.setModelRet(policy);
        }

        args.setDocumentRet(policy.retrievePolicyDocument());
    }
}
