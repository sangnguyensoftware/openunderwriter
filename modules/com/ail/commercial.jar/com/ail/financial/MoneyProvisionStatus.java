...
/**
 * Type safe enumeration representing states of a money provision
 */
public enum MoneyProvisionStatus implements TypeEnum {
    /** Undefined */
    NEW("New"),
    REQUESTED("Requested"),
    ...
    MoneyProvisionStatus() {
        this.longName=name();
    }
    
    MoneyProvisionStatus(String longName) {
     ...
     */
    public static MoneyProvisionStatus forName(String name) {
        return (MoneyProvisionStatus)Functions.enumForName(name, values());
    }
