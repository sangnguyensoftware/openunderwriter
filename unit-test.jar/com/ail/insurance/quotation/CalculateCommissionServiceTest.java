...
public class CalculateCommissionServiceTest {

    CalculateCommissionService sut;
    
    @Mock
    private CalculateCommissionService.CalculateCommissionArgument args;
    @Mock
    private Core core;
    @Mock
    ...
    @Mock
    private CalculatePolicyCommissionCommand calculatePolicyCommissionCommand;
    ...
    public void setUp() throws Exception {
        ...
        sut=new CalculateCommissionService();
        ...
        doReturn(calculatePolicyCommissionCommand).when(core).newCommand(eq("CalculatePolicyCommission"), eq(CalculatePolicyCommissionCommand.class));
        doReturn(assessmentSheet).when(calculatePolicyCommissionCommand).getAssessmentSheetArgRet();
    }
