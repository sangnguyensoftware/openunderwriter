...
/**
 * PageFlow action to generate the schedule document for the current quotation.
 * The document will be generated and persisted with the policy.
 */
public class GenerateScheduleDocumentAction extends Action {
        ...
        if (getWhen().equals(currentPhase)) {
            if (conditionIsMet(model)) {
                try {
                    ...
                    FetchDocumentCommand cmd = proxy.newCommand("FetchScheduleDocument", FetchDocumentCommand.class);
                    ...
                    throw new RenderingError("Failed to generate/display schedule", e);
                }
            }
        }
        return model;
