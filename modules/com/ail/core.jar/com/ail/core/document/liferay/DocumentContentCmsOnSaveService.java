...
public class DocumentContentCmsOnSaveService extends Service<LifeCycleArgument> {
    ...
    public void invoke() throws BaseException, PreconditionException, PostconditionException {
        ...
        FileEntry fileEntry = manager.createDocument(documentContent.getContent());

        documentContent.getForeignSystemReference().put("Liferay", new ForeignSystemReference("Liferay", fileEntry.getTitle()));
        }
        catch(Throwable t) {
            t.printStackTrace();
        }
