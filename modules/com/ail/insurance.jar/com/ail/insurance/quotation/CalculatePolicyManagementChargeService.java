...
@ServiceInterface
public interface CalculatePolicyManagementChargeService {

    @ServiceArgument
    public interface CalculatePolicyManagementChargeArgument extends Argument {
        /**
    ...
    @ServiceCommand
    public interface CalculatePolicyManagementChargeCommand extends Command, CalculatePolicyManagementChargeArgument {
    }
}
