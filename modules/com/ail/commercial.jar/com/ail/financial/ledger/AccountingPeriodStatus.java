...
public enum AccountingPeriodStatus implements TypeEnum {
    OPEN("i18n_account_status_open"),
    CLOSED("i18n_account_status_closed");
    ...
    AccountingPeriodStatus(String longName) {
     ...
     */
    public static AccountingPeriodStatus forName(String name) {
        return (AccountingPeriodStatus)Functions.enumForName(name, values());
    }
