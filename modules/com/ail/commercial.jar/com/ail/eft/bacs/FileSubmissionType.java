...
public enum FileSubmissionType implements TypeEnum {

	SINGLE_FILE_SUBMISSION("SingleFileSubmission"),
	MULTI_FILE_SUBMISSION("MultiFileSubmission");
    ...
    FileSubmissionType(String longName) {
     ...
     */
    public static FileSubmissionType forName(String name) {
        return (FileSubmissionType) Functions.enumForName(name, values());
    }
