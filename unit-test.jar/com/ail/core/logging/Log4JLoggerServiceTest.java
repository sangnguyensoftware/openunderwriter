...
public class Log4JLoggerServiceTest {

    @Mock
    private Log4JLoggerService sut;
    @Mock
    ...
    @Before
    public void setup() {
        sut = spy(new Log4JLoggerService());
        sut.setArgs(args);
    ...
    public void testMappingOfDebugSeverity() {
        ...
        sut.invoke();
        verify(logger).log(eq(Level.DEBUG), any(String.class), any(Throwable.class));
    }
    ...
    public void testMappingOfWarningSeverity() {
        ...
        sut.invoke();
        verify(logger).log(eq(Level.WARN), any(String.class), any(Throwable.class));
    }
    ...
    public void testMappingOfErrorSeverity() {
        ...
        sut.invoke();
        verify(logger).log(eq(Level.ERROR), any(String.class), any(Throwable.class));
    }
    ...
    public void testMappingOfFatalSeverity() {
        ...
        sut.invoke();
        verify(logger).log(eq(Level.FATAL), any(String.class), any(Throwable.class));
    }
}
