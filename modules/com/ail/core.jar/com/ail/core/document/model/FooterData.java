...
public class FooterData extends BlockData {
    ...
    public void render(RenderContext context) {
        if (conditionIsMet(context.getModel())) {
            context.getOutput().printf("<footerData%s%s%s%s applicability=\"%s\">", idAsAttribute(), titleAsAttribute(), styleClassAsAttribute(), orderAsAttribute(), getApplicabilityAsString());
            if (leftLogo != null) {
