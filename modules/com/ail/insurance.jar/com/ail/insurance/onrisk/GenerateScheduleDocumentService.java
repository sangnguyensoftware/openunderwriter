...
public class GenerateScheduleDocumentService extends Service<GenerateScheduleDocumentService.GenerateScheduleDocumentArgument> {
    private static final long serialVersionUID = 3198893603833694389L;

    @ServiceArgument
    public interface GenerateScheduleDocumentArgument extends Argument {
        /**
    ...
    @ServiceCommand(defaultServiceClass=GenerateScheduleDocumentService.class)
    public interface GenerateScheduleDocumentCommand extends Command, GenerateScheduleDocumentArgument {}
	...
	public void invoke() throws BaseException {
        ...
        gdc.setDocumentDefinitionArg("ScheduleDocument");
