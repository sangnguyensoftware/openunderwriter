...
public class GeneratePolicyDocumentService extends Service<GeneratePolicyDocumentService.GeneratePolicyDocumentArgument> {
    private static final long serialVersionUID = 3198893603833694389L;

    @ServiceArgument
    public interface GeneratePolicyDocumentArgument extends Argument {
        /**
    ...
    @ServiceCommand(defaultServiceClass=GeneratePolicyDocumentService.class)
    public interface GeneratePolicyDocumentCommand extends Command, GeneratePolicyDocumentArgument {}
	...
	public void invoke() throws BaseException {
        ...
        gdc.setDocumentDefinitionArg("PolicyDocument");
