...
public class CalculateBrokerageServiceTest {

    CalculateBrokerageService sut;
    
    @Mock
    private CalculateBrokerageService.CalculateBrokerageArgument args;
    @Mock
    private Core core;
    @Mock
    ...
    @Mock
    private CalculatePolicyBrokerageCommand calculatePolicyBrokerageCommand;
    
    @Before
    public void setUp() throws Exception {
        MockitoAnnotations.initMocks(this);
        
        sut=new CalculateBrokerageService();
        ...
        doReturn(calculatePolicyBrokerageCommand).when(core).newCommand(eq("CalculatePolicyBrokerage"), eq(CalculatePolicyBrokerageCommand.class));
        doReturn(assessmentSheet).when(calculatePolicyBrokerageCommand).getAssessmentSheetArgRet();
    }
