...
/**
 * PageFlow action to generate the policy document for the current quotation.
 * The document will be generated and persisted with the policy object.
 */
public class GeneratePolicyDocumentAction extends Action {
        ...
        if (getWhen().equals(currentPhase)) {
            if (conditionIsMet(model)) {
                try {
                    ...
                    FetchDocumentCommand cmd = proxy.newCommand("FetchPolicyDocument", FetchDocumentCommand.class);
                    ...
                    throw new RenderingError("Failed to generate/display policy", e);
                }
            }
        }
        return model;
