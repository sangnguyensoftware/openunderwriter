...
/**
 * The BuyWithIWinPayButton requires that the policy contains a IWinPay based
 * MoneyProvision at status NEW. This method creates such a MoneyProvision.
 */
public class AddIWinPayMoneyProvisionToPolicyService {
